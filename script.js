...
header_button.addEventListener("click", function() {
    ...
    if (header.classList.contains("open")) {
        ...
        header_button.querySelector("img").src = "https://cdn-icons.flaticon.com/png/512/2997/premium/2997911.png?token=exp=1638500090~hmac=3d972ef4af40d1b41da031c2b257a094";
    }
});
...
if (src){
    ...
    new_p.innerText = text? text:"Стандартная подпись";
